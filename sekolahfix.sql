...
--
-- Indexes for table `detail_pembagian_kelas`
--
...
--
-- Indexes for table `filelampiran`
--
ALTER TABLE `filelampiran`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `filelampiran_beasiswa`
--
...
--
-- Indexes for table `ketakhirsiswa`
--
ALTER TABLE `ketakhirsiswa`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketayah`
--
ALTER TABLE `ketayah`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketibu`
--
ALTER TABLE `ketibu`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketkesehatan`
--
ALTER TABLE `ketkesehatan`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketkompetensi`
--
ALTER TABLE `ketkompetensi`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketlulus`
--
ALTER TABLE `ketlulus`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketpindahan`
--
ALTER TABLE `ketpindahan`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `kettmpttinggal`
--
ALTER TABLE `kettmpttinggal`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `ketwali`
--
ALTER TABLE `ketwali`
  ADD PRIMARY KEY (`nis`);

--
-- Indexes for table `kuotajurusan`
--
...
--
-- Indexes for table `notifikasi_beasiswa`
--
...
--
-- Indexes for table `penilaian_beasiswa`
--
ALTER TABLE `penilaian_beasiswa`
  ADD PRIMARY KEY (`idPenilaianBea`);

--
-- Indexes for table `periode_beasiswa`
--
...
--
-- Indexes for table `t_siswadaftar`
--
...
--
ALTER TABLE `t_beasiswa`
  MODIFY `idbeasiswa` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=512749;
