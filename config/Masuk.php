...
if($cek > 0){
	...
	}else if($_SESSION['menu'] == "absensi") {
		header("location:http://localhost:8080/sissmkn2/views/dashboard/absensi/index.php");
	}
	}else{
		echo "<script type='text/javascript'>
			window.alert('Username or/and Password incorrect');
			window.location.href='location:http://localhost:8080/sissmkn2/views/login/login/index.php'
		</script>";
		exit;
	}
