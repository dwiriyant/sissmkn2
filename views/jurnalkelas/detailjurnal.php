								...
								<div class="card-body">
									<form action="#" method="GET" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-6">
                                                <div class="col col-md-3">
                                                    <label for="disabled-input" class=" form-control-label">User ID</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="disabled-input" name="userid" value="<?= $item['userid']; ?>" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                		...
                                		<div class="row form-group">
                                    		<div class="col-6">
                                        		<div class="col col-md-3">
                                        			<label for="disabled-input" class=" form-control-label">Guru</label>
                                        		</div>
                                        		<div class="col-12 col-md-9">
                                        			<input type="text" id="disabled-input" name="nama" value="<?= $item['nama']; ?>" class="form-control" readonly>
                                        		</div>
                                    		</div>
                                		</div>
                                        <div class="row form-group">
