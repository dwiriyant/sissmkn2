                        ...
                        <div class="card-body">
                          <table id="coba" class="table table-striped table-bordered">
                                ...
                                ?>
                                 <tr>
                                 <th scope="row"><?= $i++; ?></th>
                                <td><?= $data['idbelajar']; ?></td>
                                <td><?= $data['thajar']; ?></td>
                                <td><?= $data['sem']; ?></td>
                                <td><?= $data['pelajaran']; ?></td>
                                <td>
                                      <a href="detail_mapel.php?idbelajar=<?=$data['idbelajar']; ?>"><button title="Detail" type="button" class="btn btn-primary btn-sm"><i class="fa ti-eye"></i></button>
                                      <a href="edit_mapel.php?idbelajar=<?=$data['idbelajar']; ?>"><button title="Ubah" type="button" class="btn btn-success btn-sm"><i class="fa ti-pencil-alt"></i></button></a>
                                      <a href="proses.php?idbelajar=<?=$data['idbelajar']; ?> &aksi=hapus"> <button title="Hapus" type="button" class="btn btn-danger btn-sm"><i class="fa ti-eraser"></i></button>
                                      </td>
                                      </td>
