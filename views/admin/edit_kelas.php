                          ...
                          $id = $_GET["id_kelas"];?>
                                ...
                                ?>
                                          ...
                                          <div class="col-6">
                                              ...
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kode Kelas</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="kelas" name="kelas" placeholder="" class="form-control"value="<?= $data['kelas']; ?>"></div>
                                              </div>
                                          </div>
                                      <div class="col-6">
                                              <div class="form-group">
                                          ...
                                          <div class="col-6">
                                              ...
                                              <div class="col-12 col-md-9"><input type="text" id="ruang" name="ruang" placeholder="" class="form-control"value="<?= $data['ruang']; ?>"></div>
                                              </div>
                                              </div>
                                          <div class="col-6">
                                              <div class="form-group">
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Ketua Kelas</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="ketua" name="ketua" placeholder="" class="form-control"value="<?= $data['ketua']; ?>"></div>
                                              </div>
                                              </div>    
                                          <div class="col-6">
                                              <div class="form-group">
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Masuk</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="masuk" name="mask" placeholder="" class="form-control"value="<?= $data['masuk']; ?>"></div>
                                              </div>
                                              </div>
                                          <div class="col-6">
                                              <div class="form-group">
                                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Guru BK</label></div>
                                              <div class="col-12 col-md-9"><input type="text" id="guru_bk" name="guru_bk" placeholder="" class="form-control"value="<?= $data['guru_bk']; ?>"></div>
                                              </div>
                                              </div>
                                          <div class="col-6">
                                              <div class="form-group">
