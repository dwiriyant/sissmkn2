                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="col">
                                              <div class="form-check">
                                                    <input type="radio" id="L" name="kelamin" value="L" class="form-check-input">Laki - laki
                                                </div>

                                                <div class="form-check">
                                                    <input type="radio" id="P" name="kelamin" value="P" class="form-check-input">Perempuan
                                                </div>
                                            </div>
                                          </div>
                                      </label>
...
<strong class="card-title"><font size="1"><font color='BLACK'>Penting : <font color='red'>Disarankan file yang diupload / yang dilampirkan ukurannya tidak lebih dari 2 MB dan bagi koneksi internetnya lambat, disarankan menguload file lampiran 1 persatu simpan sampai semua lampiran terupload.</strong></font></font></br></font>
                                      <div class="row" style = "margin-top:13px;">
                                          ...
                                          <div class="col-6">
                                            ...
                                            <div class="col-12 col-md-9"><input type="file" name="sis_nisn" class="form-control"onchange="PreviewImage();"></div>
                                          </div>
                                      </div>
